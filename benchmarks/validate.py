...
def main():
    ...
    with Native(a.executable, a.model, raw=True, allow_truncation=a.allow_truncation, fp32=a.fp32, fp16=a.fp16, flash=not a.no_flash, tensor_core=a.tensor_core_fp32, backend=a.backend) as native:
